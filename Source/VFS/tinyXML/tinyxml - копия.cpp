...
bool TiXmlDocument::LoadFile( const char* filename, TiXmlEncoding encoding, const char * pBuffer, long nSize )
{
	...
	value = ( NULL == filename ) ? "no file name" : filename;
